...
export function FeaturedProjectCard({ project }: FeaturedProps) {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] lg:grid-cols-[1fr_400px]">
        {/* Left: Content */}
        <div className="p-8 lg:p-10 flex flex-col">
          ...
          <p className="text-text-secondary leading-relaxed mb-6 flex-grow text-[0.95rem]">
            {project.overview}
          </p>
        ...
        <div
          className="relative hidden md:flex items-center justify-center overflow-hidden min-h-[280px]"
          style={{
            background: 'linear-gradient(135deg, #1a2f33 0%, #0f1e21 100%)',
          }}
        >
          {/* Dot grid texture */}
          <div
            ...
            style={{
              backgroundImage: 'radial-gradient(circle, #3A5559 1px, transparent 1px)',
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, transparent 40%, #5CB3FF 41%, #5CB3FF 42%, transparent 43%)',
            }}
          />
          {/* Type watermark */}
          <span
            className="relative text-5xl font-black uppercase tracking-tighter select-none"
            style={{
              color: 'rgba(92, 179, 255, 0.08)',
          ...
          <div className="absolute bottom-4 right-4">
            <span className="text-xs text-text-muted/50 font-medium tracking-wide">Image coming soon</span>
          </div>
        </div>
      </div>
    </article>
